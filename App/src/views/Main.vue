<template>
  <v-navigation-drawer
    ...
    <div class="empty"
      v-if="showCategory && nbrCatt === 0 || showComposant && nbrComposant === 0"
    >
      <img 
        :src="img_empty" 
        alt="img_emplty"
    ...
    <div class="catts_container_noCatt"
      v-if="showCategory && noCattContent"
    >
      <Category
    ...
    >
      ...
      <template v-slot:append>
        ...
        >
          ...
          <v-list 
            style="padding-left: 10px; background: linear-gradient(to top left, #212121, #37474F, #212121); border-radius: 20px;"
            elevation="20"
          >
          <div>
              <div class="addChoice">
